...
<div class="responsive-container">
    <div class="container">
        <div class="bread-crumb">
            ...
            <a href="{{route('admin.grade.book.chapters.index', [$book->grade,$book])}}">{{ $book->name }}</a>
            <i class="bx bx-chevron-right"></i>
            <div>New Chapter</div>
        </div>
                ...
                <form action="{{route('admin.book.chapters.store', $book)}}" method='post' class="md:w-2/3">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div>
                            ...
                            <input type="number" name="chapter_no" value="{{ $book->chapters->max('chapter_no') + 1 }}" class="custom-input-borderless" min=1>
                        </div>
                        <div class="md:col-span-2">
