...
<div class="custom-container">
    ...
    <div class="content-section md:p-16">
        ...
        <div class="flex items-center flex-wrap justify-between gap-3 mt-3">
            ...
            <a href="{{route('admin.book.chapter.questions.create',[$book->id, $chapter->id])}}" class="btn-teal rounded">New</a>
        </div>
            ...
            <table class="table-fixed w-full mt-3">
                ...
                <tbody>
                    ...
                    <tr class="tr">
                        ...
                        <td>{{ $question->type->name }}, {{ $question->subtype->name }}</td>
                        <td>
                        ...
                        <td>
                            <div class="flex justify-center items-center space-x-3">
                                <a href="{{route('admin.book.chapter.questions.edit', [$book->id, $chapter->id, $question])}}">
                                    <i class="bx bx-pencil text-green-600"></i>
                                </a>
                                <span class="text-slate-400">|</span>
                                <form action="{{route('admin.book.chapter.questions.destroy', [$book->id, $chapter->id, $question])}}" method="POST" onsubmit="return confirmDel(event)">
                                    @csrf
                                    @method('DELETE')
